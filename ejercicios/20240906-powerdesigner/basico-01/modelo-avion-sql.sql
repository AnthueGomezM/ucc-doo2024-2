...
/* Created on:     6/09/2024 8:37:41 p. m.                      */
/*==============================================================*/
...
alter table ITINERARIO
   add constraint FK_ITINERAR_RF_CIUDAD_LLEGADA foreign key (CIUDAD_LLEGADA_ID)
      references CIUDAD (ID)
      on delete restrict on update restrict;

alter table ITINERARIO
   add constraint FK_ITINERAR_REFERENCI_AVION foreign key (AVION_ID)
      references AVION (ID)
      on delete restrict on update restrict;
